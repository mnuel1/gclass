      ...
      <div className="bg-slate-100">
        ...
        <div className="mx-4 grid lg:grid-cols-[1fr_0.3fr] gap-4 grid-cols-1">
          <div className="lg:block flex flex-col gap-4">
            ...
            <div className="px-4 py-5 bg-white rounded-xl lg:h-[12rem] col-start-1">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-full">
                <TooltipProvider delayDuration={100}>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <p className="text-sm md:text-2xl text-2xl lg:text-4xl font-bold">
                ...
                >
                  <p className="text-sm md:text-2xl lg:text-4xl font-bold">
                ...
                <TooltipProvider delayDuration={100}>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <p className="text-sm md:text-2xltext-2xl lg:text-4xl font-bold">
                          {metrics.totalGrade}
                        </p>
          ...
          <div className="px-4 py-5 bg-white rounded-xl col-start-1">
            <div className="w-full flex flex-col sm:flex-row justify-between mb-4 items-center">
              <h1 className="font-semibold text-sm md:text-lg lg:text-2xl">
                Your assignments
              </h1>
              <NavLink
