...
export const StudentAccountSettings: React.FC = () => {
  ...
  const splitUserFullName = () => {
    ...
    const [last, first, middle] = fullName
        ...
        <div className="bg-white grow">
          ...
          <div className="flex flex-col gap-4 p-12 ">
            ...
            <button
              disabled={!edit}
              type="button"
              className={`w-full md:w-[8%] justify-center p-2 rounded-md text-white flex items-center gap-2 hover:bg-blue-500 bg-blue-600 ${
