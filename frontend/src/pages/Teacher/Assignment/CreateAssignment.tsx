  ...
  return (
    <>
      ...
      <form
        ...
        className="overflow-y-auto h-full pb-24"
      >
        <div className="p-4 m-6 flex flex-col gap-6 ">
          ...
          <div>
            <div className="flex flex-col sm:flex-row items-center gap-4 border border-gray-200 rounded-lg p-4">
		...
		w-full rounded-lg border border-gray-200 p-4 pe-12 text-sm shadow-sm"
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col md:flex-row items-center w-fit sm:max-w-md gap-2">
                <div>
                  <input
                    type="date"
                    name="date"
