...
export const ViewAssignment: React.FC = () => {
  ...
  const MembersDialog = () => (
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" className="ml-4 w-full p-2">
          <p className="text-xs md:text-md">Manage Members</p>
        </Button>
      </DialogTrigger>
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between flex-col sm:flex-row px-4 py-4">
        <Button
          variant="link"
      ...
      <Tabs defaultValue="classwork" className="w-full">
        <TabsList className="grid w-[85%] md:w-fit grid-cols-1 md:grid-cols-2 h-full mx-4">
          <TabsTrigger value="classwork">Classwork</TabsTrigger>
          <TabsTrigger value="assignment">Assignment</TabsTrigger>
        </TabsList>

        <TabsContent value="classwork" className="h-[75vh] pb-24">
          <form
            action=""
          ...
          >
		    ...
		    <MembersDialog />
              ...
              <div className="pb-2 self-start md:self-end">
                <Button
                  disabled={!edit}
                  type="submit"
        ...
        <TabsContent value="assignment" className="h-[75vh] pb-40">
          <div className="h-full mx-4 flex flex-col gap-4 overflow-y-auto">
