...
import {
  ...
  useEditMeeting,
  useMeetingQuery,
} from "../../process/Calendar/useCalendarQuery";
                        ...
                        <>
                          ...
                          <div className="mt-2 space-y-1">
                            {getEventsForDay(day).map((event, idx) => (
                              <div
                                key={idx}
                                className="flex flex-col justify-between text-sm bg-blue-300 p-1 rounded-lg overflow-hidden"
                              >
                                <span className="text-xs md:text-md font-bold">{event.title}</span>
                                <span className="text-xs md:text-md text-gray-500 font-semibold">
                                  {(() => {
                                    let [hour, minute] = event.time.split(":");
                                    hour = parseInt(hour);
