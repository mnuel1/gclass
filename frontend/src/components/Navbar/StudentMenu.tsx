...
const active =
  "text-black bg-blue-100 rounded-lg px-4 py-2 flex items-center gap-2 cursor-pointer";
const notActive =
  "text-black hover:bg-gray-200 rounded-lg px-4 py-2 flex items-center gap-2 w-full cursor-pointer";
  ...
  return (
    <>
      <div className="flex flex-col min-h-screen">
        {/* Header */}
        <div
          className="flex flex-col md:flex-row md:items-center bg-white w-full md:h-[4rem] 
        ...
        >
          <div className="flex gap-4">
            ...
            <button
              className={`${
                window.location.href.split("/").pop() === "meeting"
                  ? "hidden"
                  : "block"
              } hidden lg:block `}
                  ...
                  <ul className="space-y-1 p-2">
                    ...
                    <li>
                      <a
                        ...
                        className={`hover:bg-gray-200 block rounded-lg  px-4 py-2 text-sm font-medium text-gray-700`}
                      >
                        Log-out
                      </a>
                    </li>
            ...
            <div className="flex items-center gap-2 p-2">
              <div className="rounded-full w-[40px] flex justify-center p-2 bg-blue-200 font-bold">
                {firstLetter}
              </div>
        ...
        <div className="flex flex-col md:flex-row grow">
          {/* Sidebar */}
          <div
            className={`p-4 bg-white hidden lg:flex flex-col gap-6 justify-start 
          ...
          >
            ...
            >
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="size-8 text-black cursor-pointer rounded-full"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
