...
interface ModalProps {    
    onClose: () => void;
    onSubmit: (assignment_id : string) => void
    assignment_id: string;
  }

export const DeleteAssignmentModal: React.FC<ModalProps> = ({ onClose, assignment_id, onSubmit}) => {
                            ...
                            <div className="flex flex-col rounded-lg">                     
                                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                    <div className="sm:flex sm:items-start">
                                        ...
                                        <h1 className="text-2xl font-bold leading-6 text-gray-900">Delete assignment</h1>
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                            Are you sure you want to delete this assignment? All of data or records in this assignment will be permanently removed.
                                ...
                                <div className="bg-gray-200 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                    <button
                                        type="button"
                                        onClick={() => onSubmit(assignment_id)}
